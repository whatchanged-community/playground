import{t as F,c as H,m as N,r as v,o as x,a as C,w as u,b as p,u as c,n as M,g as E,d as b,e as T,f as j,h as i,i as I,j as P,k as V,l as $,p as O,q as G,s as B,v as D,x as q,B as z,I as U,F as K,T as k,S as Q}from"./vendor.71d799ba.js";import W from"https://esm.sh/copy-to-clipboard";import J from"https://cdn.jsdelivr.net/npm/codemirror/src/codemirror.js";const X=function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function l(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerpolicy&&(a.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?a.credentials="include":e.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=l(e);fetch(e.href,a)}};X();const Y=["innerHTML"],Z={props:{content:String,loading:Boolean},setup(m){const d=m,{content:l,loading:o}=F(d),e=H(()=>N(l.value));return(a,s)=>{const _=v("a-spin");return x(),C(_,{spinning:c(o)},{default:u(()=>[p("div",M(E(a.$attrs)),[p("div",{innerHTML:c(e)},null,8,Y)],16)]),_:1},8,["spinning"])}}};const S={props:{content:{type:String},readonly:{type:Boolean,default:()=>!1},loading:Boolean},emits:["update:content"],setup(m,{emit:d}){const l=m,{content:o,readonly:e,loading:a}=F(l);let s;const _=b(null);T(()=>{s=J.fromTextArea(_.value,{lineNumbers:!0,readonly:!!e}),typeof o.value=="string"&&w(o.value),s.on("change",(y,R)=>{d("update:content",s.doc.getValue())})});function w(y){s.doc.setValue(y)}return(y,R)=>{const n=v("a-spin");return x(),C(n,{spinning:c(a)},{default:u(()=>[p("div",j({class:"my-editor"},y.$attrs),[p("textarea",{ref:(t,r)=>{r.input=t,_.value=t}},null,512)],16)]),_:1},8,["spinning"])}}};const ee={props:{content:String,loading:Boolean},setup(m){const d=m,{content:l,loading:o}=F(d);return(e,a)=>{const s=v("a-tab-pane"),_=v("a-tabs");return x(),C(_,{class:"render"},{default:u(()=>[i(s,{key:"1",tab:"Result"},{default:u(()=>[i(Z,{content:c(l),loading:c(o),class:"markdown",style:{"padding-left":"30px"}},null,8,["content","loading"])]),_:1}),i(s,{key:"2",tab:"Source"},{default:u(()=>[i(S,{content:c(l),loading:c(o),readonly:!0},null,8,["content","loading"])]),_:1})]),_:1})}}},te=`## {{ .Version }} ({{ .Date }})
